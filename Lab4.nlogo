extensions [table]
globals [u headings actions is_stop?]
...
to setup
  ...
  set is_stop? false
  set-patch-size 40
  ask patches [set plabel-color 5]
  ask patches with [
  ...
  [set pcolor one-of [white red green black black black black black black black black black]]
...
to-report get-reward
  if (pcolor = brown) [report 1000]
  if (pcolor = white) [report -100]
  if (pcolor = black) [report -0.5]
  if (pcolor = green) [report 0.5]
